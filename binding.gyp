  ...
  "targets": [
    {
      ...
      "sources": [ "bitprim_addon.cc", 
                   ...
                   "src/chain/header.cc", 
                   "src/chain/block.cc", 
                   "src/chain/merkle_block.cc", 
                   "src/chain/point.cc", 
                   "src/chain/transaction.cc", 
                   "src/chain/input.cc", 
                   "src/chain/output.cc", 
                   "src/chain/output_point.cc", 
                   "src/chain/tools.cc",
                   "src/chain/script.cc", 
                   "src/chain/input_list.cc", 
                   "src/chain/output_list.cc", 
                   "src/chain/transaction_list.cc",
